...
public enum ConfigEnums {
    ...
    USAGE_SET_LEFT_COMMAND("messages.usage.setleftcommand", "&cUsage: /commanditems setleftcommand <command>"),
    USAGE_SET_RIGHT_COMMAND("messages.usage.setrightcommand", "&cUsage: /commanditems setrightcommand <command>"),
